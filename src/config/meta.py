...
class SageMakerMeta:
    def __init__(self, args):
        ...
        self.sagemaker_role = \
            "arn:aws:iam::602570579971:role/MLOpsSageMakerExecutionRole"  # <ACCOUNT> 수정 602570579971
        ...
        self.s3_base_path = \
            f"s3://mlops-recommend-system-new-user/ns={args.namespace}"  # <유저명> 수정 new-user
